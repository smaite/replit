...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6 flex justify-between items-center">
        <div>
            <a href="/vendor/" class="text-primary hover:text-indigo-700 mb-2 inline-block">
                <i class="fas fa-arrow-left"></i> Back to Dashboard
            </a>
            <h1 class="text-3xl font-bold text-gray-900">My Products</h1>
        </div>
        <a href="/vendor/add-product.php" class="bg-primary hover:bg-indigo-700 text-white px-6 py-3 rounded-lg font-medium">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <?php if (empty($products)): ?>
            <div class="p-12 text-center">
                ...
                <a href="/vendor/add-product.php" class="inline-block bg-primary text-white px-8 py-3 rounded-lg hover:bg-indigo-700 font-medium">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <a href="/vendor/edit-product.php?id=<?php echo $product['id']; ?>" 
                                           class="text-green-600 hover:text-green-700" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="/vendor/products.php?delete=<?php echo $product['id']; ?>" 
