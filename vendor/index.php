...
$page_title = 'Vendor Dashboard - SASTO Hub';
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">
                <i class="fas fa-store text-primary"></i> Vendor Dashboard
            </h1>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="/vendor/add-product.php" class="bg-primary hover:bg-indigo-700 text-white text-center py-4 rounded-lg font-medium transition">
                    <i class="fas fa-plus-circle text-2xl mb-2 block"></i>
                    Add Product
                </a>
                <a href="/vendor/products.php" class="bg-green-600 hover:bg-green-700 text-white text-center py-4 rounded-lg font-medium transition">
                    <i class="fas fa-box text-2xl mb-2 block"></i>
                    My Products
                </a>
                <a href="/vendor/orders.php" class="bg-yellow-600 hover:bg-yellow-700 text-white text-center py-4 rounded-lg font-medium transition">
                    <i class="fas fa-shopping-cart text-2xl mb-2 block"></i>
                    Orders
                </a>
                <a href="/vendor/settings.php" class="bg-gray-600 hover:bg-gray-700 text-white text-center py-4 rounded-lg font-medium transition">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="/vendor/products.php" class="text-primary hover:text-indigo-700 font-medium">
            ...
            <?php if (empty($recent_products)): ?>
                <div class="text-center py-8">
                    ...
                    <a href="/vendor/add-product.php" class="inline-block mt-4 bg-primary text-white px-6 py-2 rounded-lg hover:bg-indigo-700">
                            ...
                            <?php foreach ($recent_products as $product): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <a href="/vendor/edit-product.php?id=<?php echo $product['id']; ?>" class="text-blue-600 hover:text-blue-700 mr-3">
