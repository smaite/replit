<?php
// Admin Header - Custom header for admin panel
...
<head>
    ...
    <meta name="description" content="SASTO Hub Admin Panel">
    <meta name="theme-color" content="#4F46E5">
    <meta http-equiv="Cache-Control" content="no-store, no-cache, must-revalidate, max-age=0">
    <meta http-equiv="Pragma" content="no-cache">
    <meta http-equiv="Expires" content="0">
    <title><?php echo $page_title ?? 'Admin Panel - SASTO Hub'; ?></title>
        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div class="flex items-center gap-4">
                <a href="/admin/" class="text-2xl font-bold">
                    <i class="fas fa-cogs"></i> SASTO Admin
                </a>
            </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white text-gray-900 rounded-lg shadow-lg hidden group-hover:block z-50">
                        <a href="/admin/settings.php" class="block px-4 py-2 hover:bg-gray-100 border-b">
